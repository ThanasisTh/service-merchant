...
public class ShutdownHook extends Thread {
    ...
    @Override
    public void run() {
        System.out.println("Shutting down merchant service...");
        ...
        try {
            ...
            System.out.println("Error while shutting down merchant service.");
            System.out.println(e.toString());
        }

        System.out.println("Merchant service successfully shut down.");
    }
}